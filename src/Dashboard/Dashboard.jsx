...
const Dashboard = () => {
	...
	<div className="space-y-3">
		...
		<div className="relative">
			...
			<input type="search" name="Search" placeholder="Search..." className="  py-2 pl-10 text-sm dark:border-transparent rounded-md focus:outline-none dark:bg-gray-800 dark:text-gray-100 focus:dark:bg-gray-900" />
		</div>
		<div className="flex-1">
			<ul className="pt-2 pb-4 space-y-1 text-sm">
				...
				<li className="rounded-sm">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
					<span className="text-xl"><IoMdCreate /></span>
						<NavLink to={'createtask'} ><span>Create New Tasks</span></NavLink>
					</a>
				</li>
				<li className="rounded-sm">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
                    
                    <span className="text-xl"><MdOutlineDoneAll /></span>
						<NavLink to={'draglist'} ><span> Previous Tasks list</span></NavLink>
					</a>
				</li>
				<li className="rounded-sm">
					<a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
						...
						<NavLink to={'features'} ><span>Features
</span></NavLink>
					</a>
				</li>
